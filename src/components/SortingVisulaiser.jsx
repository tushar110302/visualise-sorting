 ...
 return (
    <div className="visualizer-container">
      ...
      <footer className="app-footer">
        <ul>
          <li>
            <button className="btn btn-new-array" onClick={initialiseArray}>
              Create new array
            </button>
          </li>
          <li>
            <button className="btn btn-merge-sort" onClick={mergeSort}>
              Merge sort
            </button>
          </li>
          <li>
          ...
          <li>
            <button className="btn btn-quick-sort" onClick={quickSort}>
              Quick sort
            </button>
          </li>
        </ul>
